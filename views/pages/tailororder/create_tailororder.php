...
<form class='form-horizontal' action='create-tailororder' method='post' enctype='multipart/form-data'>
<?php
	$html="";
	...
	$html.=input_field(["label"=>"Delivery Datetime","type"=>"text","name"=>"txtDeliveryDatetime"]);
