      ...
      <div class="row">
          <div class="col-12 p-3">
              ...
              <div class="shadow-lg" style="background-color:#bdbdbd">
                <table class="table">  
                 <tr ><td colspan="6"style="background:#b0bec5"><h3 class="d-flex justify-content-center ">Money Receipt</h3></td></tr>
                 <tr><td colspan="6"style="background:#90a4ae"><h2 class="d-flex justify-content-center">Munshi tailor & fabrics</h2></td></tr>
                 <tr><td colspan="6"style="background:#90a4ae"><h5 class="d-flex justify-content-center">propritor:Helal munshi<br>mobile:01961631322<br>B.H.T, Naoujur, Gajipur.</h5></td></tr>
