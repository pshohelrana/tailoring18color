      ...
      <div class="row">
          <div class="col-12 p-3">
              ...
              <div class="shadow-lg" style="background-color:#d1c4e9">
                <table class="table">  
                 <tr ><td class="img" style="background:#8c9eff"><img src='img/tailor mohi.png' height="100" width="100"/></td><td colspan="7"style="background:#8c9eff"><h1 class="d-flex justify-content-center ">Invoice </h1></td></tr>
